...
namespace Logic.Tests
{
    public class StopTargetExitTests
    {
        ...
        {
            var results = new List<List<double>> { new List<double>(), new List<double>() };
            return results;
        }
        ...
        {
            var resultsLong = LoadData(Directory.GetCurrentDirectory() + "\\StopTarget\\longResults.txt");
        ...
        {
            var resultsLong = LoadData(Directory.GetCurrentDirectory() + "\\StopTarget\\shortResults.txt");
            for (var i = 0; i < resultsLong.Count; i++)
