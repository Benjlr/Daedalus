...
namespace TestUtils
{
    public class FBETestBars
    {
        public static BidAskData[] DataLong = new BidAskData[]
        {
            ...
            new BidAskData(new DateTime(1, 1, 4), 13, 12.5, 14, 13.5, 13, 12.5, 11, 10.5, 678), //13b9, b13   13/9            13b9    b13
        ...
        public static List<Trade> longTradesOne = new List<Trade>()
        {
        ...
        public static List<Trade> longTradesTwo = new List<Trade>()
        {
        ...
        public static List<Trade> shortTradesOne = new List<Trade>()
        {
        ...
        public static List<Trade> shortTradesTwo = new List<Trade>()
        {
